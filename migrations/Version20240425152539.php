 ...
 */
final class Version20240425152539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, cours_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, age SMALLINT NOT NULL, firstname VARCHAR(70) NOT NULL, INDEX IDX_34DCD1767ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
